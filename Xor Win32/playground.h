...
class playground {
 public:
    ...
    QString names[24];                    // Die Dateinamen der bitmaps            
    QString level;                        // Die Level-Datei (z.B. level01.xor)
    QString level_name;                   // Der offizielle Level-Name (z.B. "The Decoder")
    QString directory;                    // der Pfad zum Arbeitsverzeichnis
 ...
 public:
    playground(QString,QString);                  
    playground(QString,QString,Graphics *);
    ~playground();
    ...
    void saveMoves(QString );
    void loadMoves(QString );
    void animation(int);
    void greetingScreen();
    void failureScreen();
    void successScreen();
